...
function CardItem({ card, dynamic }) {
  return (
    <div className="max-w-xs shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-110 relative bg-black">
      <img
      ...
      <div className="p-2">
        <div
          className={`p-2 animate-hologram
                    ${
                      card.origin_rate === 1
                        ? "tscard"
                        : card.origin_rate === 2
        ...
        >
          {/* 타이틀 */}
          <div
            className={`mx-1 p-2 flex flex-row justify-between items-center rounded shadow-md shadow-gray-400 relative z-10
                        ${
                          card.origin_rate === 1
                            ? "tscard"
                            : card.origin_rate === 2
          ...
          >
            <div className="flex flex-row gap-2 items-center">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(255, 255, 255, 1) 0%, rgba(150, 150, 150, 1) 100%)",
                  boxShadow:
                    "0 2px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19)",
                }}
              >
              ...
              <h2 className="text-black font-bold text-bordered">
                {card.name}
              </h2>
            </div>
            {dynamic ? (
          ...
          <div className="mr-2 flex flex-row justify-end">
            {Array(dynamic ? Number(dynamic.rate) : card.origin_rate)
              .fill()
              .map((_, i) => (
                <img key={i} className="w-4" src={"./assets/star.png"} />
              ))}
          </div>
          {/* 이미지 */}
          <div
            className={`m-2 pt-8 rounded shadow-md shadow-gray-400 relative z-10
                        ${
                          card.origin_rate === 1
                            ? "scard"
                            : card.origin_rate === 2
            ...
            >
              ...
              <div className="flex flex-row justify-evenly">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(120, 50, 30, 0.3) 0%, rgba(120, 50, 30, 1) 100%)",
                    boxShadow:
                      "0 2px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19)",
                  }}
                >
                    ...
                    if (skill) {
                      return (
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg, rgba(255, 20, 50, 1) 0%, rgba(120, 185, 120, 1) 50%, rgba(123, 73, 164, 1) 100%)",
                            boxShadow:
                              "0 2px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19)",
                          }}
                        >
                ...
                {Array(5 - card.origin_rate)
                  ...
                  .map((v, i) => (
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, rgba(250, 250, 250, 0.3) 0%, rgba(120, 120, 120, 1) 100%)",
                        boxShadow:
                          "0 2px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19)",
                      }}
                    >
